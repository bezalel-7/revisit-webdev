...
const Cart = () => {
  ...
  const { cart } = useSelector((state) => state) // Assuming you have a 'cart' state in your Redux store
    ...
    <div>
      {cart.length > 0 ? (
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center">
          ...
          <Link to="/">
            <button className="bg-black hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-black font-bold hover:text-black p-3">
              SHOP NOW
            </button>
          </Link>
        </div>
